...
/**
* tässä luodaan dashboardiin oma POST ryhmä
Täällä otetaan kiinni callbackit ja luodaan rakenne dashboardiin ja itse cpt
*/
class CustomPostTypeController extends BaseController {
    ...
    public function setSettings() {
		$args = array(
			array(
				'option_group' => 'santeri_plugin_cpt_settings',
				'option_name' => 'santeri_plugin_cpt',
    ...
    public function setFields() {
		...
		$args = array(
                array(
                 ...
                 'page' => 'testi_cpt',
                 'section' => 'santeri_cpt_index',
                 'args' => array(
                     'option_name' => 'santeri_plugin_cpt',
                     'label_for' => 'post_type',
                     'placeholder' => 'esim. projektit'
                      )
                 ),
                 array(
                    'id' => 'singular_name',
    ...
    public function storeCustomPostTypes() {
        ...
        foreach ($options as $option) {
         ...
         $this->custom_post_types[] = array(
            ...
            'supports'              => array( 'title', 'editor', 'thumbnail' ), #tässä määritellään cpt 
            'taxonomies'            => array( 'category', 'post_tag' ),
            'hierarchical'          => false,
            'public'                => $option['public'],
            'show_ui'               => true, #tsekaappa
            'show_in_menu'          => true,
            'menu_position'         => 10,
